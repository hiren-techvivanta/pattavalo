...
//               {/* <div className="pt-5">
//                 <button
//                   className="relative inline-flex items-center border border-white text-white font-medium px-6 py-3 rounded-full overflow-hidden transition-all duration-500 ease-in-out group"
//                   style={{
...
//                 >
//                   <div
//                     className={`absolute right-6 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-[#2E437C] transition-transform duration-[1000ms] ease-in-out will-change-transform ${
...
//                   <span
//                     className={`relative z-10 ml-3 rounded-full h-8 w-8 flex items-center justify-center transition-colors duration-300 ${
//                       isHovered
//                         ? " text-white"
//                         : "bg-[#2E437C] text-white"
//                     }`}
//                   >
//                     <MdArrowOutward
//                       size={18}
      ...
      <motion.div
        ...
        style={{
          boxShadow: isVideoExpanded
            ? "none"
            : "0 0 0 20px white, 0 0 0 24px rgba(0,0,0,0.1)",
        }}
      />
