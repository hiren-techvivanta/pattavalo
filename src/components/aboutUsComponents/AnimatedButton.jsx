...
const AnimatedButton = ({
  ...
  return (
    <button
      className={`relative cursor-pointer  inline-flex items-center  bg-white font-medium px-${px} py-${py} rounded-full overflow-hidden transition-all duration-[600ms] ease-in-out group `}
